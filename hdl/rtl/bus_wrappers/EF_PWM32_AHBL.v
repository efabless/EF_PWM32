...
`endif
	...
	localparam	CMPA_REG_OFFSET = `AHBL_AW'h0000;
	localparam	CMPB_REG_OFFSET = `AHBL_AW'h0004;
	localparam	TOP_REG_OFFSET = `AHBL_AW'h0008;
	localparam	CLKDIV_REG_OFFSET = `AHBL_AW'h000C;
	localparam	CONTROL_REG_OFFSET = `AHBL_AW'h0010;
	localparam	GENA_REG_OFFSET = `AHBL_AW'h0014;
	localparam	GENB_REG_OFFSET = `AHBL_AW'h0018;
	...
	`AHBL_REG(CMPA_REG, 0, 32)

	reg [31:0]	CMPB_REG;
	assign	cmpB = CMPB_REG;
	`AHBL_REG(CMPB_REG, 0, 32)

	reg [31:0]	TOP_REG;
	assign	top = TOP_REG;
	`AHBL_REG(TOP_REG, 0, 32)

	reg [3:0]	CLKDIV_REG;
	assign	clkdiv = CLKDIV_REG;
	`AHBL_REG(CLKDIV_REG, 0, 4)
	...
	assign	HRDATA = 
			(last_HADDR[`AHBL_AW-1:0] == CMPA_REG_OFFSET)	? CMPA_REG :
			(last_HADDR[`AHBL_AW-1:0] == CMPB_REG_OFFSET)	? CMPB_REG :
			(last_HADDR[`AHBL_AW-1:0] == TOP_REG_OFFSET)	? TOP_REG :
			(last_HADDR[`AHBL_AW-1:0] == CLKDIV_REG_OFFSET)	? CLKDIV_REG :
			(last_HADDR[`AHBL_AW-1:0] == CONTROL_REG_OFFSET)	? CONTROL_REG :
			(last_HADDR[`AHBL_AW-1:0] == GENA_REG_OFFSET)	? GENA_REG :
			(last_HADDR[`AHBL_AW-1:0] == GENB_REG_OFFSET)	? GENB_REG :
