...
`endif
	...
	localparam	CMPA_REG_OFFSET = `APB_AW'h0000;
	localparam	CMPB_REG_OFFSET = `APB_AW'h0004;
	localparam	TOP_REG_OFFSET = `APB_AW'h0008;
	localparam	CLKDIV_REG_OFFSET = `APB_AW'h000C;
	localparam	CONTROL_REG_OFFSET = `APB_AW'h0010;
	localparam	GENA_REG_OFFSET = `APB_AW'h0014;
	localparam	GENB_REG_OFFSET = `APB_AW'h0018;
	...
	`APB_REG(CMPA_REG, 0, 32)

	reg [31:0]	CMPB_REG;
	assign	cmpB = CMPB_REG;
	`APB_REG(CMPB_REG, 0, 32)

	reg [31:0]	TOP_REG;
	assign	top = TOP_REG;
	`APB_REG(TOP_REG, 0, 32)

	reg [3:0]	CLKDIV_REG;
	assign	clkdiv = CLKDIV_REG;
	`APB_REG(CLKDIV_REG, 0, 4)
	...
	assign	PRDATA = 
			(PADDR[`APB_AW-1:0] == CMPA_REG_OFFSET)	? CMPA_REG :
			(PADDR[`APB_AW-1:0] == CMPB_REG_OFFSET)	? CMPB_REG :
			(PADDR[`APB_AW-1:0] == TOP_REG_OFFSET)	? TOP_REG :
			(PADDR[`APB_AW-1:0] == CLKDIV_REG_OFFSET)	? CLKDIV_REG :
			(PADDR[`APB_AW-1:0] == CONTROL_REG_OFFSET)	? CONTROL_REG :
			(PADDR[`APB_AW-1:0] == GENA_REG_OFFSET)	? GENA_REG :
			(PADDR[`APB_AW-1:0] == GENB_REG_OFFSET)	? GENB_REG :
