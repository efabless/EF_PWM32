...
`endif
	...
	localparam	CMPA_REG_OFFSET = `WB_AW'h0000;
	localparam	CMPB_REG_OFFSET = `WB_AW'h0004;
	localparam	TOP_REG_OFFSET = `WB_AW'h0008;
	localparam	CLKDIV_REG_OFFSET = `WB_AW'h000C;
	localparam	CONTROL_REG_OFFSET = `WB_AW'h0010;
	localparam	GENA_REG_OFFSET = `WB_AW'h0014;
	localparam	GENB_REG_OFFSET = `WB_AW'h0018;
	...
	`WB_REG(CMPA_REG, 0, 32)

	reg [31:0]	CMPB_REG;
	assign	cmpB = CMPB_REG;
	`WB_REG(CMPB_REG, 0, 32)
	...
	assign	dat_o = 
			(adr_i[`WB_AW-1:0] == CMPA_REG_OFFSET)	? CMPA_REG :
			(adr_i[`WB_AW-1:0] == CMPB_REG_OFFSET)	? CMPB_REG :
			(adr_i[`WB_AW-1:0] == TOP_REG_OFFSET)	? TOP_REG :
			(adr_i[`WB_AW-1:0] == CLKDIV_REG_OFFSET)	? CLKDIV_REG :
			(adr_i[`WB_AW-1:0] == CONTROL_REG_OFFSET)	? CONTROL_REG :
			(adr_i[`WB_AW-1:0] == GENA_REG_OFFSET)	? GENA_REG :
			(adr_i[`WB_AW-1:0] == GENB_REG_OFFSET)	? GENB_REG :
			32'hDEADBEEF;
